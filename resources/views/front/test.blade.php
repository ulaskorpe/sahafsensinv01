            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h4 class="font-weight-semi-bold mb-4">
                        Şu an fiyatı : <span id="current_price">{{$product['current_price']}}&#8378;</span> <br> Hemen Al :  {{$product['buy_now_price']}}&#8378; </h4>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" class="form-control bg-secondary border-0 text-center" value="{{$product['bid_price']}} &#8378;">
                            <div class="input-group-btn">
                                <button class="btn btn-primary btn-plus" onclick="add_bid('{{$product['id']}}','{{$product['bid_price']}}')">
                                    <i class="fa fa-plus"></i>
                                </button>
                            </div>
                        </div>
                        <button class="btn btn-primary px-3" style="margin-right: 10px"><i class="fa fa-shopping-cart mr-1"></i>Sepete Ekle</button>
                        <button class="btn btn-primary px-3"><i class="fa fa-solid fa-bolt  mr-1"></i>Hemen Al</button>
                    </div>
